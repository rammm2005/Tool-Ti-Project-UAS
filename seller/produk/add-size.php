    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        ...
        <div class="bg-white p-3 shadow-md rounded-sm">
            ...
            <form class="py-3 px-3" method="POST"
                action="../db/controller/size/insert_action.php">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Tambahkan Ukuran baru
                    </h2>
                    <p class="mt-1 text-sm leading-6 text-gray-600">Tambahkan Ukuran baru untuk menambahkan ukuran produk anda.</p>

                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="nama" class="block text-sm font-medium leading-6 text-gray-900">Add Size</label>
                            <div class="mt-2">
                                <input type="text" name="besar_ukuran" id="nama" placeholder="XL or L"
                        ...
                        <div class="sm:col-span-3">
                            <label for="desk" class="block text-sm font-medium leading-6 text-gray-900">Size Description</label>
                            <div class="mt-2">
                                <input type="text" name="desk" id="desk" placeholder="Extra Large or Large"
                                    autocomplete="family-name"
                                    class="block w-full rounded-md border-0 py-2 px-6 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button type="submit" name="add-ukuran"
